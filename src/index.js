...
function extendConf (conf) {
  ...
  conf.boot.push('~quasar-app-extension-db-table/src/boot/register-db-table.js')

  // make sure boot & component files get transpiled
  conf.build.transpileDependencies.push(/quasar-app-extension-db-table[\\/]src/)

  // make sure my-ext css goes through webpack to avoid ssr issues
  conf.css.push('~quasar-app-extension-db-table/src/component/DbTable.styl')
}
